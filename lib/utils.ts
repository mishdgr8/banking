...
export const authFormSchema = (type: string) =>
  z.object({
    ...
    password: z.string().min(8, {
      message: "Password must contain morethan 8 or more charcaters",
    }),
    ...
    postalCode:
      type === "sign-in" ? z.string().optional() : z.string().min(2).max(7),
    dateOfBirth: type === "sign-in" ? z.string().optional() : z.string(),
    ssn: type === "sign-in" ? z.string().optional() : z.string().max(10),
  });
